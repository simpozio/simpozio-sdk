...
var Heartbeat = function () {
    ...
    _createClass(Heartbeat, [{
        ...
        value: function addListener(event, cb) {
            ...
            _events2.default.addListener(event, cb);
            ...
            var helper = function helper() {
                ...
                var handleReject = function handleReject(error) {
                    ...
                    if (online) {
                        ...
                        _events2.default.emit(_const.HEARTBEAT_RN_EVENT_FAIL, error);
                    }
                ...
                var handleResponse = function handleResponse(_ref2) {
                    ...
                    if (!online) {
                        _events2.default.emit(_const.HEARTBEAT_RN_EVENT_RESUME, {
                ...
                _this.cancelToken = _this.api.makeCancelToken;
        ...
        value: function removeSubscription(key) {
            ...
            _events2.default.removeListener(event, cd);
